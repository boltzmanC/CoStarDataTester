...
namespace CoStarDataTester
{
    public class NightlyFeedTester
    {
        ...
        public static void CostarAutoTestNightlyFeedFile()
        {
            ...
            //Read the E1 Files.
            CostarReadE1SiteReportFiles(e1gapsitesinfo, e1variablelist);
        ...
        public static void CostarManualTestNightlyfile()
        {
        ...
        // reformat nightly feed to match annual deliverable format.
        ...
        // unseen
        private static void CostarReadE1SiteReportFiles(Dictionary<string, Dictionary<string, List<string>>> e1gapsitesinfo, HashSet<string> e1variablelist)
        {
            //bool allmatch = true;
